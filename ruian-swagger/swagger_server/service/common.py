...
from swagger_server.service.models import none_to_string, formatzip_code, empty_string_if_no_number, alpha_check, \
    PrettyAddressInternal
...
def compile_address_as_dictionary_cz(
    ...
    if "district_number" in work:
        if work["district_number"] is not None:
            if str(work["district_number"]) != '':
